<!-- Backend Variables -->
<?php
  require_once 'includes/RGBtoHSL.php';

  $header_logo_height = get_field('fvt_header_logo_height', 'option');
  $header_padding_top = get_field('fvt_header_padding_top', 'option');
  $header_padding_bottom = get_field('fvt_header_padding_bottom', 'option');
...
<style>
  ...
  <?php if ($display_font_url): ?>@import url('<?php echo $display_font_url; ?>');<?php endif; ?>
  ...
  :root {
    ...
    --fvt-header-padding-top: <?php echo $header_padding_top . 'px'; ?>;
    --fvt-header-padding-bottom: <?php echo $header_padding_bottom . 'px'; ?>;
  }
</style>
